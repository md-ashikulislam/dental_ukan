...
from archs import AttentionUKAN  # Import the required model directly
ARCH_NAMES = ['AttentionUKAN'] 
...
def parse_args():
    ...
    # model
    parser.add_argument('--arch', '-a', metavar='ARCH', default='AttentionUKAN')
